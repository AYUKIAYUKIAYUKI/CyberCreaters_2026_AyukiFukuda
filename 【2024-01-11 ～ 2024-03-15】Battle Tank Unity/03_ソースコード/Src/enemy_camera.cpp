...
// 視点を算出
//************************************************
void CalcPosV_ENC(const D3DXVECTOR3 target)
{
	// 視点は対象物の後方に
	g_EditCamera.posV =
	{
...
// 注視点を算出
//************************************************
void CalcPosR_ENC(const D3DXVECTOR3 target)
{
	// 注視点を対象物の前方に
	g_EditCamera.posR =
	{
