...
void UpdateDebugProc(void)
{
	...
	// デバッグ表示をスクロール
	if (GetKeyboardPress(DIK_LALT) && GetKeyboardPress(DIK_NUMPAD8))
	{
		g_slide += 5;
	}
	else if (GetKeyboardPress(DIK_LALT) && GetKeyboardPress(DIK_NUMPAD5))
	{
		g_slide -= 5;
	}
...
{
	RECT rect = { 0, g_slide, SCREEN_WIDTH, SCREEN_HEIGHT };
