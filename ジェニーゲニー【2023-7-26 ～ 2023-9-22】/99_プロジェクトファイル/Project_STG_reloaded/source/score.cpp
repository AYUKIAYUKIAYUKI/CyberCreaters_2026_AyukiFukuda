...
void SetPos_Vtx_Score(void)
{
	...
	//黒い棒を適当な位置へ
	pVtx_Score[0].pos = D3DXVECTOR3(385.0f, 20.0f, 0.0f);
	pVtx_Score[1].pos = D3DXVECTOR3(700.0f, 20.0f, 0.0f);
	pVtx_Score[2].pos = D3DXVECTOR3(360.0f, 100.0f, 0.0f);
	pVtx_Score[3].pos = D3DXVECTOR3(675.0f, 100.0f, 0.0f);
	...
	for (int nCnt = 0; nCnt < AMOUNT_USING_POLYGON_NUMBER_SCORE; nCnt++)
	{
		if (nCnt == AMOUNT_USING_POLYGON_NUMBER_SCORE - 1)
		{
			...
			pVtx_Score[0].pos = D3DXVECTOR3(535.0f, 40.0f, 0.0f);
			pVtx_Score[1].pos = D3DXVECTOR3(595.0f, 40.0f, 0.0f);
			pVtx_Score[2].pos = D3DXVECTOR3(535.0f, 80.0f, 0.0f);
			pVtx_Score[3].pos = D3DXVECTOR3(595.0f, 80.0f, 0.0f);
	...
	//シンボルをその辺に配置
	pVtx_Score[0].pos = D3DXVECTOR3(405.0f, 30.0f, 0.0f);
	pVtx_Score[1].pos = D3DXVECTOR3(445.0f, 30.0f, 0.0f);
	pVtx_Score[2].pos = D3DXVECTOR3(405.0f, 90.0f, 0.0f);
	pVtx_Score[3].pos = D3DXVECTOR3(445.0f, 90.0f, 0.0f);
...
void ReSetPos_Vtx_Score(void)
{
	...
	for (int nCnt = 0; nCnt < g_nScore_Digit; nCnt++)
	{
		...
		case 2:
			...
			pVtx_Score[0].pos = D3DXVECTOR3(550.0f - g_fMoveX_Score, 40.0f, 0.0f);
			pVtx_Score[1].pos = D3DXVECTOR3(610.0f - g_fMoveX_Score, 40.0f, 0.0f);
			pVtx_Score[2].pos = D3DXVECTOR3(550.0f - g_fMoveX_Score, 80.0f, 0.0f);
			pVtx_Score[3].pos = D3DXVECTOR3(610.0f - g_fMoveX_Score, 80.0f, 0.0f);

			break;

		case 3:

			pVtx_Score[0].pos = D3DXVECTOR3(565.0f - g_fMoveX_Score, 40.0f, 0.0f);
			pVtx_Score[1].pos = D3DXVECTOR3(625.0f - g_fMoveX_Score, 40.0f, 0.0f);
			pVtx_Score[2].pos = D3DXVECTOR3(565.0f - g_fMoveX_Score, 80.0f, 0.0f);
			pVtx_Score[3].pos = D3DXVECTOR3(625.0f - g_fMoveX_Score, 80.0f, 0.0f);

			break;

		case 4:

			pVtx_Score[0].pos = D3DXVECTOR3(580.0f - g_fMoveX_Score, 40.0f, 0.0f);
			pVtx_Score[1].pos = D3DXVECTOR3(640.0f - g_fMoveX_Score, 40.0f, 0.0f);
			pVtx_Score[2].pos = D3DXVECTOR3(580.0f - g_fMoveX_Score, 80.0f, 0.0f);
			pVtx_Score[3].pos = D3DXVECTOR3(640.0f - g_fMoveX_Score, 80.0f, 0.0f);

			break;

		case 5:

			pVtx_Score[0].pos = D3DXVECTOR3(595.0f - g_fMoveX_Score, 40.0f, 0.0f);
			pVtx_Score[1].pos = D3DXVECTOR3(655.0f - g_fMoveX_Score, 40.0f, 0.0f);
			pVtx_Score[2].pos = D3DXVECTOR3(595.0f - g_fMoveX_Score, 80.0f, 0.0f);
			pVtx_Score[3].pos = D3DXVECTOR3(655.0f - g_fMoveX_Score, 80.0f, 0.0f);

			break;

		case 6:

			pVtx_Score[0].pos = D3DXVECTOR3(610.0f - g_fMoveX_Score, 40.0f, 0.0f);
			pVtx_Score[1].pos = D3DXVECTOR3(670.0f - g_fMoveX_Score, 40.0f, 0.0f);
			pVtx_Score[2].pos = D3DXVECTOR3(610.0f - g_fMoveX_Score, 80.0f, 0.0f);
			pVtx_Score[3].pos = D3DXVECTOR3(670.0f - g_fMoveX_Score, 80.0f, 0.0f);
