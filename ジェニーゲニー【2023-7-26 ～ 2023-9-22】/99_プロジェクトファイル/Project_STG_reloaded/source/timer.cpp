...
void SetPos_Vtx_Timer(void)
{
	...
	//黒い棒をその辺に配置
	pVtx_Timer[0].pos = D3DXVECTOR3(0.0f, 20.0f, 0.0f);
	pVtx_Timer[1].pos = D3DXVECTOR3(365.0f, 20.0f, 0.0f);
	pVtx_Timer[2].pos = D3DXVECTOR3(0.0f, 100.0f, 0.0f);
	pVtx_Timer[3].pos = D3DXVECTOR3(340.0f, 100.0f, 0.0f);
	...
	{
		//時間をその辺に配置
		pVtx_Timer[0].pos = D3DXVECTOR3(85.0f + g_fMoveX_Timer, 40.0f, 0.0f);
		pVtx_Timer[1].pos = D3DXVECTOR3(145.0f + g_fMoveX_Timer, 40.0f, 0.0f);
		pVtx_Timer[2].pos = D3DXVECTOR3(85.0f + g_fMoveX_Timer, 80.0f, 0.0f);
		pVtx_Timer[3].pos = D3DXVECTOR3(145.0f + g_fMoveX_Timer, 80.0f, 0.0f);
	...
	{
		//記号をその辺に配置
		pVtx_Timer[0].pos = D3DXVECTOR3(142.5f + g_fMoveX_Timer, 45.0f, 0.0f);
		pVtx_Timer[1].pos = D3DXVECTOR3(192.5f + g_fMoveX_Timer, 45.0f, 0.0f);
		pVtx_Timer[2].pos = D3DXVECTOR3(142.5f + g_fMoveX_Timer, 80.0f, 0.0f);
		pVtx_Timer[3].pos = D3DXVECTOR3(192.5f + g_fMoveX_Timer, 80.0f, 0.0f);
	...
	//時計をその辺に配置
	pVtx_Timer[0].pos = D3DXVECTOR3(25.0f, 35.0f, 0.0f);
	pVtx_Timer[1].pos = D3DXVECTOR3(75.0f, 35.0f, 0.0f);
	pVtx_Timer[2].pos = D3DXVECTOR3(25.0f, 85.0f, 0.0f);
	pVtx_Timer[3].pos = D3DXVECTOR3(75.0f, 85.0f, 0.0f);
